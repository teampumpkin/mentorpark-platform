                ...
                <div class="text-end">
                    <div class="button-group">
                        @if(auth()->user()->role_names[0] == 'Organization')
                            <a href="{{ route('frontend.organization.mentors.add', ['organization_id' => auth()->user()->organization_id]) }}"
                                ...
                                <div class="col-md-4 mentor-list">
                                    <div class="card border-secondary border">
                                        <div class="card-body">
                                                ...
                                                <ul class="list-inline d-flex justify-content-between w-100" style="padding:0;">
                                                    <li class="list-inline-item">
                                                        <img
                                                            ...
                                                            alt="{{ $mentor->name }}" class="object-cover mb-3 profile-img">
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <strong>{{ $mentor->name }}</strong>
                                                        <br> {{ $mentor->information->job_title }}
                                                    </li>
                                                    <li class="list-inline-item ms-auto">
                                                        @if(!empty($mentor->organization_id))
                                                            <img
                                                                src="{{ asset('storage/' . $mentor->organization->logo_path) }}"
                                                                alt="{{ $mentor->organization->name ?? '' }}"
                                                                title="{{ $mentor->organization->name ?? '' }}"
                                            ...
                                            <ul class="list-inline d-flex gap-3" style="color: #5D29A6; overflow: hidden;">
                                                @foreach($mentor->skills->take(3) as $skill)
                                                    <li class="badge-soft-secondary p-1 rounded">{{ $skill->name }}</li>
                                                @endforeach
                                            </ul>


                                            <a href="{{ route('frontend.organization.user.profile', ['organization_id' => $user->organization_id, 'mentor_id' => $mentor->user_slug]) }}" class="btn btn-purple w-100 mt-6 hover:bg-purple-800 text-white px-6 py-2 rounded-lg w-full flex items-center justify-center space-x-2 transition">
