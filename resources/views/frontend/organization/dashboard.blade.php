...
{{--                        <img src="{{ asset('storage/' . $user->organization->logo_path) }}" alt="Logo" width="40">--}}
                        {{ $user->organization->name ?? 'Organization' }}'s Dashboard
                    </h2>
                </div>
                <div class="text-end">
                    <div class="button-group">
                        <button class="btn btn-purple">Schedule session</button>
                        <button class="btn btn-black">Start mentoring program</button>
                        <button class="btn btn-green">Post a new job</button>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="card-content">
                                            <div class="icon-area">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M10 0.625C15.1777 0.625 19.375 4.82233 19.375 10C19.375 15.1777 15.1777 19.375 10 19.375C4.82233 19.375 0.625 15.1777 0.625 10C0.625 4.82233 4.82233 0.625 10 0.625Z" stroke="#ffffff" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M10.364 5.09277V10.5473L14.0004 12.3655" stroke="#F2B035" stroke-width="1.13636" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
