                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            ...
                            @endif
                            <form action="{{ route('frontend.master-classes.store') }}" method="post" class=""
                                  id="master_Class_form" enctype="multipart/form-data">
                                @csrf
                                <div class="mt-5">
                                    <!-- Tab Navigation -->
                                        ...
                                        <div class="tab-pane fade show active" id="details" role="tabpanel"
                                            ...
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-2">
                                                            <label class="form-label" for="name">Title of
                                                                Masterclass</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-2">
                                                            <label class="form-label" for="name">Timezone</label>
                                                            <select class="form-control" name="timezone" id="timezone">
                                                                <option value="Africa/Abidjan">Africa/Abidjan</option>
                                                                <option value="Africa/Accra">Africa/Accra</option>
                                                                <option value="Africa/Addis_Ababa">Africa/Addis_Ababa
                                                                </option>
                                                                ...
                                                                <option value="Asia/Calcutta" selected>Asia/Calcutta
                                                                </option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-2">
                                                            <label class="form-label d-block">Masterclass
                                                                Description</label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="banner-upload-card"
                                                            ...
                                                            <span
                                                                class="banner-upload-text">Upload a banner image</span>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            <label for="menteeInput" class="form-label">Invite
                                                                Mentees</label>
                                                        ...
                                                        <ul id="selectedList" class="list-group mt-2"></ul>
                                                        <ul id="newMenteeList" class="list-group mt-2"></ul>
                                                    </div>


                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="attachments">Upload
                                                                attachments</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="price">Pricing of
                                                            masterclass</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="session_price_discount">Discount
                                                            value</label>
