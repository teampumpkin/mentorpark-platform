    ...
    initLeftSidebar() {
        ...
        ((e = $(".side-nav li .collapse")),
            ...
            setTimeout(function () {
                ...
                null != t && ((e = document.querySelector(".sidenav-menu .simplebar-content-wrapper")), (t = t.offsetTop - 300), e && 100 < t && ((i = 600), (o = (n = e).scrollTop), (r = t - o), (l = 0), s()));
            }, 200));
    }
    initTopbarMenu() {
        $(".navbar-nav").length &&
...
class ThemeCustomizer {
   ...
   /* changeTopbarColor(e) {
    ...
    changeTopbarColor(e) {
       ...
       /* const topbarColor = this.html.getAttribute('data-topbar-color');
        const darkLogo = 'http://intern-park.io/logo-dark.svg';   // for light topbar background (dark logo)
        const lightLogo = 'http://intern-park.io/logo-light.svg'; // for brand topbar background (light logo)

        if (topbarColor === 'light') {
            console.log('light');
            $('.logo-lg img').attr('src', darkLogo);
            $('.logo-sm img').attr('src', darkLogo);
        } else if (topbarColor === 'brand') {
            console.log('brand');
            $('.logo-lg img').attr('src', lightLogo);
            $('.logo-sm img').attr('src', lightLogo);
        } else {
            // fallback for other colors like 'dark', 'gradient', etc.
            console.log('default');
            $('.logo-lg img').attr('src', lightLogo);
            $('.logo-sm img').attr('src', lightLogo);
        }*/
                ...
                e.addEventListener("click", function () {
                    ...
                    "full" === t
                        ...
                        : "fullscreen" == e
                            ...
                            : "sm-hover" == e
                                ? "sm-hover" === t
                                    ? a.changeLeftbarSize("sm-hover" == e ? "sm-hover-active" : e, !0)
                                    : a.changeLeftbarSize("sm-hover", !0)
                                : "sm-hover-active" == e
                                    ? "sm-hover-active" === t
                                        ? a.changeLeftbarSize("sm-hover-active" == e ? "sm-hover" : e, !0)
    ...
    setSwitchFromConfig() {
        ...
        var e,
            ...
            i = this.config;
        i &&
        ((e = document.querySelector("input[type=radio][name=data-layout][value=" + i.nav + "]")),
            (t = document.querySelector("input[type=radio][name=data-bs-theme][value=" + i.theme + "]")),
            (a = document.querySelector("input[type=radio][name=data-topbar-color][value=" + i.topbar.color + "]")),
            (n = document.querySelector("input[type=radio][name=data-menu-color][value=" + i.menu.color + "]")),
            (i = document.querySelector("input[type=radio][name=data-sidenav-size][value=" + i.sidenav.size + "]")),
        e && (e.checked = !0),
        t && (t.checked = !0),
        a && (a.checked = !0),
        n && (n.checked = !0),
