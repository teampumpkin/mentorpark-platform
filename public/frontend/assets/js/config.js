!(function () {
    var t = sessionStorage.getItem("__ABSTACK_CONFIG__"),
        ...
        i = { theme: "light", topbar: { color: "light" }, menu: { color: "light" }, sidenav: { size: "sm-hover-active" } },
    ...
    (window.innerWidth <= 1140 ? e.setAttribute("data-sidenav-size", "full") : e.setAttribute("data-sidenav-size", config.sidenav.size),
